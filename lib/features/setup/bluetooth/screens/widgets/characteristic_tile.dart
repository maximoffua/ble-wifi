...
class _CharacteristicTileState extends State<CharacteristicTile> {
  ...
  Future onReadPressed() async {
    try {
      await c.read();
      talker.good('read successful');
    } catch (e) {
      talker.error('read failed', e);
    }
  }
  ...
  Future onWritePressed() async {
    try {
      ...
      talker.good('Write: Success');
      if (c.properties.read) {
        await c.read();
      }
    } catch (e) {
      talker.error('Write Error', e);
    }
  }
  ...
  Future onSubscribePressed() async {
    try {
      ...
      talker.good("$op: Success");
      if (c.properties.read) {
        await c.read();
      }
      setState(() {});
    } catch (e) {
      talker.error("Subscribe Error", e);
    }
  }
